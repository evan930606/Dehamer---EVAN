...
class MSRB(nn.Module):
    def __init__(self, n_feat, height, width, stride, bias):
        # n_feat = 128, height = 3, width = 1, stride = 2, bias = false
        ...
        FEATS = [int((stride**i)*n_feat) for i in range(height)] # => [128, 256, 512]
        SCALE = [2**i for i in range(1,height)] # => [2, 4]
