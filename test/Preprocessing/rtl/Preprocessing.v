...
input                   i_ack;
input                   i_last;
input  [R_DATA_BIT-1:0] i0_r;
input  [G_DATA_BIT-1:0] i0_g;
input  [B_DATA_BIT-1:0] i0_b;
output                  o_rdy;
output                  o_ack;
output                  o_last;
output [DATA_BIT-1:0]   o0_r;
output [DATA_BIT-1:0]   o0_g;
output [DATA_BIT-1:0]   o0_b;
...
wire [PIPE_NUM-1:0] pipeline_rdy_next  = {i_rdy};
// wire [PIPE_NUM-1:0] pipeline_rdy_next  = {i_rdy, pipeline_rdy[PIPE_NUM-1:1]};
reg  [PIPE_NUM-1:0] pipeline_last;
wire [PIPE_NUM-1:0] pipeline_last_next = {i_last};
// wire [PIPE_NUM-1:0] pipeline_last_next = {i_last, pipeline_last[PIPE_NUM-1:1]};
wire                pipeline_trig      = | pipeline_last ? i_ack : (i_rdy & i_ack);
assign              o_rdy              = pipeline_rdy[0] & pipeline_trig;
assign              o_ack              = i_ack;
...
// 
wire [R_DATA_BIT-1:0] st1_i0_r = pipeline0[PIPE0_BIT-1                       : PIPE0_BIT-R_DATA_BIT];
wire [G_DATA_BIT-1:0] st1_i0_g = pipeline0[PIPE0_BIT-R_DATA_BIT-1            : PIPE0_BIT-R_DATA_BIT-G_DATA_BIT];
wire [B_DATA_BIT-1:0] st1_i0_b = pipeline0[PIPE0_BIT-R_DATA_BIT-G_DATA_BIT-1 : PIPE0_BIT-R_DATA_BIT-G_DATA_BIT-B_DATA_BIT];
...
assign                o0_r = st1_i0_r_2d_9bit + 9'b101100001;
assign                o0_g = st1_i0_g_2d_9bit + 9'b101101100;
assign                o0_b = st1_i0_b_2d_9bit + 9'b101110001;
